  ...
  return `
    <div id="pdf-content" style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;color:#1a1a1a;font-size:10px;line-height:1.45;padding:12px;">
      <style>
        ...
        .tag{background:#f0f9fa;color:#1B6B78;padding:2px 7px;border-radius:10px;font-size:8px;font-weight:600;border:1px solid #d0eef2}
        ...
        .hl{font-size:8px;color:#1B6B78;background:#f0f9fa;padding:2px 7px;border-radius:4px}
